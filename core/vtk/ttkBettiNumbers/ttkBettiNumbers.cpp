...
vtkStandardNewMacro(ttkBettiNumbers);
 ...
 */
ttkBettiNumbers::ttkBettiNumbers() {
 ...
 */
int ttkBettiNumbers::FillInputPortInformation(int port, vtkInformation *info) {
  if(port == 0) {
 ...
 */
int ttkBettiNumbers::FillOutputPortInformation(int port, vtkInformation *info) {
  if(port == 0) {
 ...
 */
int ttkBettiNumbers::RequestData(vtkInformation *ttkNotUsed(request),
  ...
  //       call SetInputArrayToProcess (see BettiNumbers.xml file).
  //
